...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml">
  ...
  <body class="<?php print $body_classes; ?> <?php print ($show_grid ? 'show-grid' : ''); ?>">
    <div id="page" class="container-16 clear-block">
      ...
      <?php endif; ?>
      <?php if ($messages): ?>
        <div id="messages" class="grid-16 clear-block">
          <?php print $messages; ?>
          <?php print $help; ?>
        </div>
      <?php endif; ?>
      <div id="main" class="column <?php print ns('grid-16', $left, 4, $right, 4) . ' ' . ns('push-4', !$left, 4); ?> omega">
      ...
      <?php if ($left): ?>
      <div id="sidebar-left" class="column alpha omega sidebar region grid-4 <?php print ns('pull-12', $right, 4); ?>">
          <?php print $left; ?>
      </div>
      <?php endif; ?>

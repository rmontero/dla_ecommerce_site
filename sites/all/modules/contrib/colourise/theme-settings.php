<?php
// $Id: theme-settings.php,v 1.1.1.10 2009/02/05 10:34:25 gibbozer Exp $
 ...
 */
  ...
  $form['colourise_container']['colourise_page_class'] = array(
    ...
    '#default_value' => $settings['colourise_page_class'],
    '#options' => array(
  ...
  $form['colourise_container']['colourise_features']['colourise_iepngfix'] = array(
    ...
    '#default_value' => $settings['colourise_iepngfix'],
  );
  ...
  $form['colourise_container']['colourise_features']['colourise_totop'] = array(
    ...
    '#default_value' => $settings['colourise_totop'],
  );
